...
figlet "ALDI HACKER"
echo $w"///////////////////////////////////////////"
echo $cy" Author"$r"  : "$cy"BANGSAT GANS"
echo $cy" pembuat"$r" : "$cy"ALDIANSYAH"
echo $cy" Team"$r"    : "$cy"Cyber Muslim Army"
echo $cy" youtube channel": $cy"Aldiansyah [aldi]"
echo $w"///////////////////////////////////////////"
	sleep 4
echo
echo
echo
echo
echo $cy"proses dulu bos tunggu 5 detik" $cy"." $r"." $g"." $y"." $b"."
         sleep 5
echo $k"₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩"
echo          $b "5 detik"
                  sleep 4
...
echo $k"₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩₩"
        sleep 4
echo
echo $cy"proses selesai......."
         sleep 4
echo
echo
echo $g"GUNAKAN DENGAN BIJAK (OK)"
        sleep 3

clear

echo $g
figlet "SELAMAT MENGGUNAKAN"
sleep 4
...
echo
echo $w"———————————————————————————————"
echo $r" Tools Hack-Fb "$w": "
echo $w"["$r"6"$w"] "$cy"Dark Fb"
echo $w"["$r"7"$w"] "$cy"MBF"
echo $w"["$r"8"$w"] "$cy"Dark Fb Premium"
...
echo $w"———————————————————————————————"
echo $p" Tools Attack : "
echo $w"["$w"11"$w"] "$g"DDOS"
echo $w"["$w"12"$w"] "$g"Hammer"
echo $w"["$w"13"$w"] "$g"Torjan"
...
echo
echo $w"———————————————————————————————"
echo $cy" Tools Hack Lainnya : "
echo $w"["$cy"16"$w"] "$r"Termux Style"
echo $w"["$cy"17"$w"] "$r"Hack CCTV"
echo $w"["$cy"18"$w"] "$r"IPGeolocation"
...
echo
echo $w"———————————————————————————————"
echo $w" Install Tools lainnya : "
echo $w"["$y"21"$w"] "$y"Tools King-Hacking"
...
sleep 2
echo $cy"ALDI ITU ORANG NYAH TAMPAN"
sleep 2
echo $cy
figlet "aldi ganteng"
sleep 2
exit
	...
	echo $r"pilih yang bener dong aldi:v"
	sleep 2
	sh 'TOOLSaldi.sh'
fi
clear
